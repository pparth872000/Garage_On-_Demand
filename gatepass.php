			...
			<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
						...
						<form action="gatepass_add.php" method="post">
							<div class="modal-body">
								<div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="txtgatepassnumber" class="form-control" required>
                                            <label class="form-label">Gatepass Number</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="txtjobcardnumber" class="form-control" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="txtvehiclename" class="form-control" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="date" name="txtservicedate" class="form-control" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="date" name="txtvehicleoutdate" class="form-control" required>
                                            <label class="form-label">Vehicleout Date</label>
                                        </div>
                                    </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                <thead>
                                    <tr>
                                       ...
                                       <th>Vehicle Name</th>
                                       <th>Service Date</th>
                                       <th>Vehicleout Date</th>
                                    </tr>
                                </thead>
                                <tbody>
								<?php
									$i=1;
									$cate=mysqli_query($con,"select * from gate_pass");
								...
								?>
                                    ...
                                    <td><?php echo $cat['Gatepass_Number']; ?></td>
                                    <td><?php echo $cat['Customer_Name']; ?></td>
                                    <td><?php echo $cat['Jobcard_Number']; ?></td>
                                    <td><?php echo $cat['vehicle_Name']; ?></td>
                                    <td><?php echo $cat['Service_Date']; ?></td>
                                    <td><?php echo $cat['Vehicle_Outdate']; ?></td>
