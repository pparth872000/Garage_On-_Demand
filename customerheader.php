        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="booking.php"><i class="material-icons"></i><span>BOOKING</span></a></li>
                    <li><a href="admingaragedetail.php"><i class="material-icons"></i><span>REGISTERED GARAGE</span></a></li>
