						...
						<form action="booking_add.php" method="post">
							<div class="modal-body">
								<div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="date" name="txtbookingdate" class="form-control" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="txtvehiclenumber" class="form-control" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="txtmnumber" class="form-control" required>
                    ...
                    <div class="card">
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
								...
								<?php
									$i=1;
									$cate=mysqli_query($con,"select * from booking_detail " );
								...
								?>
                                    ...
                                    <td><?php echo $cat['Booking_Date']; ?></td>
                                    <td><?php echo $cat['Vehicle_Name']; ?></td>
                                    <td><?php echo $cat['Vehicle_Number']; ?></td>
