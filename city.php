							...
							<div class="modal-body">
								<div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="txtcityid" class="form-control" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="txtpincode" class="form-control" required>
                    ...
                    <div class="card">
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
								...
								<?php
									$i=1;
									$cate=mysqli_query($con,"select * from city");
								...
								?>
                                    ...
                                    <td><?php echo $cat['City_Id']; ?></td>
                                    <td><?php echo $cat['City_Name']; ?></td>
                                    <td><?php echo $cat['Pincode']; ?></td>
